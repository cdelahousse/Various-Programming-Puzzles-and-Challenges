 ...
 * But more than that, when we instruct it to store an integer, we usually tell it to
 * store it in a certain datatype with a certain length. For (relatively small)
 ...
 * Note: just to be clear, for all numbers in this problem, we are using unsigned 32
 * bit integers.
 *
 */
