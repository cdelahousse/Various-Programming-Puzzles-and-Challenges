 ...
 * I.e. given the strings "Double, double, toil and trouble" and "il an" will return
 * 18, because the second substring is embedded in the first, starting on position
 * 18.
 */
